        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {[
            ...
            },
            {
              ...
              image: productionScenarios,
              status: "available"
            }
          ].map((feature, index) => (
            <Card key={index} className="card-gradient border-border/50 hover-lift group overflow-hidden">
              <CardContent className="p-0">
                ...
                <div className="p-6">
                  ...
                  <Button 
                    ...
                    onClick={() => setActiveTab(index === 0 ? "visualizer" : index === 1 ? "terminal" : index === 2 ? "concepts" : "scenarios")}
                  >
